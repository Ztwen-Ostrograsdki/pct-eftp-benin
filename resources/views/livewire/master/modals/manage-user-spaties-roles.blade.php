        ...
        <div class="relative bg-white border rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                    Gestion des rôles administrateurs de <span class="text-orange-500">{{ $user ? $user->getFullName() : "" }}</span>
                </h3>
            ...
            <form wire:ignore.self class="p-4 md:p-5">
                ...
                <div class="w-full my-2">
                    <h5 class="my-3 text-gray-500 xs:text-xs lg:text-base w-full">
                        <span>Veuillez sélectionner les rôles</span>

                        <span class="float-right text-orange-300"> {{ count($selecteds) }} rôles sélectionnés </span>
                    </h5>
                </div>
