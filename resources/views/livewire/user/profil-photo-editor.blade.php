        ...
        <div class="relative bg-white border rounded-lg shadow dark:bg-gray-800">
            ...
            <form wire:ignore.self class="p-1 md:p-5">
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="profil_photo" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                        @if(!$profil_photo)
