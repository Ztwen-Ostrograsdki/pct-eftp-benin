<footer class="bg-gray-900 w-full mt-80">
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        ...
        <div class="col-span-full lg:col-span-1 footer-element">
            ...
            <div class="mt-3 flex flex-col gap-y-2 ">
                ...
                <p class="m-0 p-0">
                    <a class=" hover:bg-gray-800 pl-2 py-1 footer-element w-full inline-block my-0 gap-x-2 text-gray-400 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{route('member.payments', ['identifiant' => auth_user()->identifiant])}}">
                        Mes cotisations
                    </a>
                </p>
        ...
        <div class="col-span-1">
            <h4 class="font-semibold text-gray-100 footer-element">Pédagogiquement </h4>
        ...
        <div class="col-span-1">
            <h4 class="font-semibold text-gray-100 footer-element">Notre association</h4>

            <div class="mt-3 grid space-y-3">
            <p>
                <a class="inline-flex footer-element gap-x-2 text-gray-400 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{route('about.us')}}">
                A propos de nous
                </a>
            </p>
            </div>
        ...
        <div class="col-span-2">
            ...
            <div class="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2 dark:bg-gray-800">
                ...
                <a class="w-full sm:w-auto whitespace-nowrap p-3 inline-flex footer-element justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                S'abonner
                </a>
            </div>
        ...
        <div>
            ...
            @guest
            <a title="S'inscrire" href="{{route('register')}}" class="w-10  h-10 inline-flex footer-element justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-primary-500 hover:bg-white/10 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-gray-600" >
            <span class="fas fa-user-plus"></span>
            </a>
            <a title="Se connecter" href="{{route('login')}}" class="w-10  h-10 inline-flex footer-element justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-success-500 hover:bg-white/10 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-gray-600" >
