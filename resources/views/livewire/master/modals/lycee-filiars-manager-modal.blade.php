...
<!-- Modal toggle -->
  <!-- Main modal -->
  <div wire:ignore.self id="lycee-filiars-manager-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                ...
                <div class="mt-3 w-full mb-5 group overflow-y-auto p-3" style="max-height: 300px">
                    ...
                    <table class="w-full text-sm text-center border rounded-lg rtl:text-right text-gray-500 dark:text-gray-400 xs:text-xs lg:text-base">
                        ...
                        <tbody>
                            ...
                            <tr wire:key="filiar-joined-to-lycee-{{$filiar->id}}" class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
