  ...
  <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
      <div class="col-span-full lg:col-span-1 footer-element">
        <a class=" flex-none text-xl font-semibold text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#" aria-label="Brand">{{ config('app.name') }}</a>
      </div>
      <!-- End Col -->
      ...
      <div class="col-span-1">
        ...
        <div class="mt-3 grid space-y-3">
          <p>
            <a class="inline-flex footer-element gap-x-2 text-gray-400 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{route('master.members.home')}}">
              A propos de nous
            </a>
          </p>
