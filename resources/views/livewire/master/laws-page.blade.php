              ...
              <div class="text-left w-full">
                <div class="relative flex flex-col">
                  <div class="w-full mx-auto flex justify-end gap-x-2 mt-2 mb-3">
                      <span wire:click='newLaw' class="border cursor-pointer hover:bg-blue-700 rounded-lg py-2 px-1 bg-blue-600 text-white font-semibold letter-spacing-1">
            ...
            <div class="grid gap-2 gap-y-2">
              ...
              <div class="py-3 w-full bg-transparent shadow ">
                <div class="w-full flex justify-start">
                  <form @submit.prevent class="w-3/5 flex justify-start">
                    <select  class="z-bg-secondary-light  font-semibold letter-spacing-1 rounded-lg shadow-1 shadow-sky-400 text-sky-300 py-3 w-full px-2" wire:model.live='laws_section_selected' id="laws_section_selected">
              ...
              @elseif($search)
                ...
                <div>
                    ...
                    <span>Aucun sujet de discussion <span class="text-warning-600"> {{ $sections[$laws_section_selected] }} </span> en cours...</span>
                    </h5>
                </div>
