	  ...
	  <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
		<div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500">
		  <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
			...
			<a wire:navigate class="font-medium hover:text-gray-500 py-3 md:py-6 {{request()->route()->named('master.members.home') ? 'text-blue-600' : 'text-gray-400' }} dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{route('master.members.home')}}">
			  L'association
			</a>
			...
			<a wire:navigate title="Télécharger des épreuves" class="transition duration-150 ease-in-out dark:focus:text-primary-500 dark:active:text-primary-600 font-medium text-gray-400 hover:text-gray-500 py-3 md:py-6  dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" >
			  Bibliothèque
			</a>
			...
			<a wire:navigate href="{{route('user.notifications')}}" class="font-medium hover:text-gray-500 py-3 md:py-6 {{request()->route()->named('user.notifications') ? 'text-blue-600' : 'text-gray-400' }} dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
			  Notifications
